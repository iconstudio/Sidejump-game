...
if global.shader_supported {
	...
	draw_surface_stretched(application_surface, global.application_offset[0], global.application_offset[1], global.application_sizes[0], global.application_sizes[1])
	//shader_reset()
